...
composer config repositories.xb vcs https://git.drupalcode.org/issue/experience_builder-3532296.git
composer require 'drupal/experience_builder:dev-3532296-html2canvas'
